    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if cart_id:
            ...
            if request.user.is_authenticated and not hasattr(request.user, 'customer'):
                ...
                Customer.objects.create(user=request.user, full_name=request.user.username)
...
class HomeView(EcomMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['myname'] = "Suraj Chaudhary"
...
class EsewaVerifyView(View):
    def get(self, request, *args, **kwargs):
        ...
        d = {
            'amt': amt,
            'scd': 'epay_payment', 
            #ailey development phase maa epay_payment rakheko cha pachii server maa haldaa esewa ley deko merchant ID halnu parcha esmaa
            'rid': refId, #Refrence ID
            'pid': oid,
        }
...
class SearchView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # kw = self.request.GET["keyword"]   esari lekhdaa pani huncha 
